  ...
  <div class="card-header">
      ...
      <div class="float-right">
        @if (permissionCheck('add'))
          <a href="{{ url('letter/roadwarrantold/add') }}" class="btn btn-secondary btn-sm">
            Buat SPJ AKAP
          </a>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group btn-block">
                @if (permissionCheck('show')) <a href="{{ url('letter/roadwarrantold/show/detail/'.$value->category.'/'.$value->uuid) }}" class="btn btn-warning btn-sm">Detail</a> @endif
                @if (permissionCheck('edit')) <a href="{{ url('letter/roadwarrantold/edit/'.$value->category.'/'.$value->uuid) }}" class="btn btn-success btn-sm">Edit</a> @endif
              </div>
            </td>
          </tr>
        @endforeach
          ...
          <tbody>
            @foreach ($bookavailable as $key => $book)
              <tr>
                ...
                <td>
                  <div class="btn-group btn-block">
                    @if (permissionCheck('add')) <a href="{{ url('letter/roadwarrantold/add/'.$book->uuid) }}" class="btn btn-warning btn-sm">Buat SPJ</a> @endif
                  </div>
                </td>
              </tr>
            @endforeach
