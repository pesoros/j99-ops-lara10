...
Route::middleware(['auth','has-permission'])->group(function () {
    Route::prefix('letter')->group(function () {
        ...
        Route::post('roadwarrant/marker-payment/{category}/{uuid}', [LetterRoadWarrantController::class, 'setMarkerWithPayment']);
        ...
        Route::post('roadwarrant/km/{uuid}', [LetterRoadWarrantController::class, 'updateKm']);
