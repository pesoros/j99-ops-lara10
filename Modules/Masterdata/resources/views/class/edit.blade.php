    ...
    <div class="card-body row">
      <div class="col-sm-12">
        ...
        <div class="form-group">
          ...
          <select class="form-control select2bs4" name="layout" style="width: 100%;">
            @foreach ($seatList as $seatListItem)
                <option value="{{ $seatListItem }}" @selected($current->layout == $seatListItem)>
                    {{ $seatListItem }}
                </option>
            @endForeach
          </select>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="seat_numbers" rows="3" placeholder="Masukkan nomor kursi">{{ $current->seat_numbers }}</textarea>
        </div>
        <div class="form-group">
