    ...
    <div class="card-body row">
      <div class="col-sm-12">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="category_name" name="category_name" placeholder="Masukkan Nama Kategori" value="{{ old('category_name') }}" required>
        </div>
        <div class="form-group">
          <label>Status</label>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="coa" name="coa" placeholder="Masukkan Nomor COA" value="{{ old('coa') }}" required>
        </div>
      </div>
    </div>
