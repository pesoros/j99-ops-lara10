...
class TripManifestController extends Controller
{
    ...
    function generateEncodingTextWa($name, $departureDate, $point) {
        ...
        $text = 'Sekedar konfirmasi untuk mengingatkan jam pemberangkatan Bapak/Ibu '.strtoupper($name).' bersama Bus Juragan 99 Trans Unit GARFIELD   besok '.dateFormat($departureDate).'
