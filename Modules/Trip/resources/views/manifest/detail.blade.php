      ...
      <div class="invoice p-3 mb-3">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <a href="{{ url('trip/manifest/close/'.$detailManifest->uuid) }}" onclick="return confirm('Anda yakin menyelesaikan Manifest ini?')" class="btn bg-gradient-primary float-right">Selesaikan manifest ini</a>
            @else
            <a href="{{ url('trip/manifest/open/'.$detailManifest->uuid) }}" onclick="return confirm('Anda yakin mermbuks Manifest ini?')" class="btn bg-gradient-primary float-right">Aktifkan manifest ini</a>
            @endif
